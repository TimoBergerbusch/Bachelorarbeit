...
\begin{frame}
	...
	\begin{itemize}
		...
		\item<3-> \red{Schlimmer}: $g$ k\"onnte mittels \glqq$=$\grqq neue Variablen einf\"uhren
...
\begin{frame} % iterationmatrix
	\frametitle{Iteration-Matrix \& Konstanten}
	\begin{itemize}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item \red{Problem}: Teile des Ray-Kriterium nicht-linear
		\uncover<2>{\item[] zwei m\"ogliche L\"osungsans\"atze:
			\begin{enumerate}
				\item nutze \qfnia
				\item iterieren \"uber unbekannte
			\end{enumerate}}
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{exampleblock}{Beispiel eines GNA \rom{1}}
...
\begin{frame}
	\begin{exampleblock}{Beispiel eines GNA \rom{2}}
		Vom \solver: $y_1=\begin{pmatrix} 9 \\ 0 \end{pmatrix}$, $y_2=\begin{pmatrix} 8 \\ -8 \end{pmatrix}$, $\mu_1=0$\newline
		\begin{itemize}
