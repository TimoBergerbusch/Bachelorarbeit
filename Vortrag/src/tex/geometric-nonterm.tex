...
\begin{frame}
	...
	\begin{itemize}
		...
		\item \red{Problem}: $\lambda_i*y_i$ is non-linear
		\item[] \green{Solution}: compute $\lambda_i$ as the $i$-th eigenvalue of $U$
...
\begin{frame}
%	\frametitle{\color{white}Domain \& Initiation Criteria}
