...
\begin{frame}[fragile]
	...
	\begin{itemize}
		\item<1-> simple Baumstruktur f\"ur \underline{ausschließlich} ber\"ucksichtigter Terme 
		\item<1-> Klassen f\"ur Konstanten, Variablen und Operatoren
	\end{itemize}
	...
	\begin{example}
		...
		\begin{tikzpicture}[
			...
			\node[below = of L] (M)  {\begin{tabular}{cc} Umgekehr Polnische Notation: \\ $+(*(3, v_1),v_2)$ \end{tabular} };
