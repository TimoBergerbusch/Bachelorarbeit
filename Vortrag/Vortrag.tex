...
\newcommand{\DrawFirstBox}[1][]{%
	\tikz[overlay,remember picture]{
		\draw[green!50!black,#1]
		($(left1)+(-0.2em,0.9em)$) rectangle
		($(right1)+(0.4em,-0.3em)$);}
}
\newcommand{\DrawFirstSmallBox}[1][]{%
	\tikz[overlay,remember picture]{
		\draw[green!50!black,#1]
		($(sleft1)+(-0.2em,0.9em)$) rectangle
		($(sright1)+(0.4em,-0.3em)$);}
}
\newcommand{\DrawSecondBox}[1][]{%
	\tikz[overlay,remember picture]{
		\draw[blue,#1]
		($(left2)+(-0.2em,0.9em)$) rectangle
		($(right2)+(0.4em,-0.3em)$);}
}
\newcommand{\DrawSecondSmallBox}[1][]{%
	\tikz[overlay,remember picture]{
		\draw[blue,#1]
		($(sleft2)+(-0.4em,0.9em)$) rectangle
		($(sright2)+(0.4em,-0.3em)$);}
}
