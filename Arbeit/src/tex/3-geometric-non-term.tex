...
\begin{figure}
	...
	\end{tikzpicture}
	\caption{The \rpntree of the term $x-3$, where the $flip$ of \Cref{algo:constant-term} has to be used. The value recursively found for the constant term is $(-1)*3 = -3$.}
