...
\begin{itemize}
	...
	\item Ausgeben lassen des IRSwTProblems durch folgenden Code:
		\lstinputlisting[language=Java, commentstyle=\fontsize{12}{14.4}\selectfont, basicstyle=\ttfamily\fontsize{10}{12}\selectfont]{listings/IRSwTProblem-Printer.java}
